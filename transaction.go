...
func createCreateAccount(node enums.Node, fromAddressBase58 string, toAddressBase58 string) (*api.TransactionExtention, error) {
	...
	return c.CreateAccount(fromAddressBase58, toAddressBase58)
}
